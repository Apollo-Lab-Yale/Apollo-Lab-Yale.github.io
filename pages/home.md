      ...
      <div class="col-md-11">
        ...
        <div style="background: rgba(255, 255, 255, 0.05); backdrop-filter: blur(8px); padding: 1.5rem; border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.1);">
          <p style="font-size: 1.15rem; line-height: 1.7; color: rgba(255, 255, 255, 0.9);">
            Our lab is driven by the high-level goal of enabling <strong>robots and learning systems to act and improve in real-time</strong>, directly within the dynamic, uncertain environments of the real world. Rather than relying on slow, offline pipelines, we develop algorithms for fast optimization, planning, and control that allow systems to continuously update their behavior as they operate. A central theme is the tight integration of perception, action, and learning, so that systems not only react quickly, but also decide what information to gather, how to interpret it, and how to adapt their actions accordingly. Across domains such as manipulation, navigation, and human interaction, we aim to build systems that are <strong>responsive, adaptive, and capable of making decisions under tight computational constraints</strong>.
          </p>
          <p style="font-size: 1.15rem; line-height: 1.7; color: rgba(255, 255, 255, 0.9);">
            To support this vision, we take a broad approach that spans learning, geometry, and applied math. We develop methods for real-time learning from streaming data, efficient techniques for derivative computation and optimization, and structured spatial representations that enable more effective reasoning about the physical world. These efforts are grounded in fundamental questions about how to represent, compute, and update information efficiently in high-dimensional, dynamic systems. We also explore how modern AI models, such as language and vision-language systems, can support interpretable and flexible planning, and how tools for geometry generation, software infrastructure, and visualization can accelerate the full pipeline from theory to deployment. Together, this work aims to move beyond static, precomputed behavior toward <strong>continuous, in-the-loop intelligence</strong>, where learning, planning, and control operate as a unified real-time process.
          </p>
          <p style="font-size: 1.15rem; line-height: 1.7; color: rgba(255, 255, 255, 0.9); margin-bottom: 0;">
            We are particularly motivated by application domains where real-time adaptability is critical and where robotics can have meaningful societal impact. These include <strong>home and assistive robotics</strong>, where systems must operate safely and intuitively in human environments; <strong>healthcare and robotic surgery</strong>, where precision, reliability, and real-time feedback are essential; and <strong>disaster response and unstructured environments</strong>, where robots must act under uncertainty with limited prior information.
          </p>
        </div>
      </div>
    </div>
